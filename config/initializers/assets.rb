...
Rails.application.config.assets.precompile += %w( PULSE-Front.jpg )
Rails.application.config.assets.precompile += %w( NatGeoJodiCobb.jpg )
Rails.application.config.assets.precompile += %w( TortoiseandTheHarePostCard.jpg )
